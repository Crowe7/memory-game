...
/* HOW DO I IMPORT BETTER ????????? */
 ...
 export const Characters:CharacterData[] = [
    ...
    {url: JigglyPuff, Name: "Jigglypuff"},
    {url: Kirby, Name: "Kirby"},
    {url: Link, Name: "Link"},
    {url: Marth, Name: "Marth"},
    {url: Mewtwo, Name: "Mewtwo"},
    {url: MrGameAndWatch, Name: "Mr. Game & Watch"},
    {url: Ness, Name: "Ness"},
    {url: Peach, Name: "Peach"},
    {url: Pichu, Name: "Pichu"},
    {url: Pikachu, Name: "Pikachu"},
    {url: Roy, Name: "Roy"},
    {url: Samus, Name: "Samus"},
    {url: Sheik, Name: "Sheik"},
    {url: Yoshi, Name: "Yoshi"},
    {url: YoungLink, Name: "Young Link"},
 ];